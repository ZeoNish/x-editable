...
(function ($) {
    ...
    */
    ...
    $.fn.editableform.template = '<form class="form-inline editableform">' +
        '<div class="control-group">' +
        '<div class="d-flex align-items-center"><div class="editable-input"></div><div class="editable-buttons btn-group d-flex w-100"></div></div>' +
        '<div class="editable-error-block"></div>' +
        '</div>' +
        '</form>';
...
(function ($) {
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead>' +
            '<tr>' +
            '<th class="prev"><i class="feather-chevron-left"/></th>' +
            '<th colspan="5" class="datepicker-switch"></th>' +
            '<th class="next"><i class="feather-chevron-right"/></th>' +
            '</tr>' +
            '</thead>',
